This CodeBook describes the variables, the data, transformations and the whole work that was performed to clean up the original data and produce the Tidy data set.
